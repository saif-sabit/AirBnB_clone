...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing show from the HBNB comnd interpreter"""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests of testing update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_invalid_class(self):
        # Test counting with multiple objects of the same class
        # Create multiple objects and then count them
        with patch("sys.stdout", new=StringIO()) as output:
